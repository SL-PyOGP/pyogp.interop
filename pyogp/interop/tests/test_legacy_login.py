...
from pyogp.lib.base.legacy_login import LegacyLogin
...
class AuthLegacyLoginTest(unittest.TestCase):
    ...
    def test_base_login(self):
        ...
        assert avatar.region.details['seed_capability'] != None or avatar.region.details['seed_capability'] != {}, "No Sim seed cap returned in the login response"
        assert avatar.region.details['look_at'] != None or avatar.region.details['look_at'] != {}, "Login response returned no look_at"
        assert avatar.region.details['sim_ip'] != None or avatar.region.details['sim_ip'] != {}, "Login response returned no sim_ip"
        assert avatar.region.details['sim_port'] != None or avatar.region.details['sim_port'] != {}, "Login response returned no sim_port"
        assert avatar.region.details['region_x'] != None or avatar.region.details['region_x'] != {}, "Login response returned no region_x"
        assert avatar.region.details['region_y'] != None or avatar.region.details['region_y'] != {}, "Login response returned no region_y"
        assert avatar.region.details['login'] != None or avatar.region.details['login'] != {}, "Login response returned no connect"
        assert avatar.region.details['session_id'] != None or avatar.region.details['session_id'] != {}, "Login response returned no session_id"
        assert avatar.region.details['secure_session_id'] != None or avatar.region.details['secure_session_id'] != {}, "Login response returned no secure_session_id"
        assert avatar.region.details['circuit_code'] != None or avatar.region.details['circuit_code'] != {}, "Login response returned no cicuit_code"
        assert avatar.region.details['first_name'] != None or avatar.region.details['circuit_code'] != {}, "Login response returned no cicuit_code"
        assert avatar.region.details['last_name'] != None or avatar.region.details['last_name'] != {}, "Login response returned no cicuit_code"
        assert avatar.region.details['agent_access'] != None or avatar.region.details['agent_access'] != {}, "Login response returned no cicuit_code"
...
{'region_y': 256512, 'region_x': 255488, 'agent_id': '2894a6f4-e565-42dd-8921-8d97bcbc26b2', 'secure_session_id': 'dea1f833-8a11-11dd-9d78-005045bbaee2', 'region_id': 31b166cf-9339-04b8-e186-f357724daae3, 'position': [117.0, 73.0, 21.0], 'sim_ip': '8.4.131.62', 'look_at': [0.0, 0.0, 0.0], 'session_id': 'dea1f563-8a11-11dd-888e-005045bbaee2', 'rez_avatar/rez': None, 'region_seed_capability': 'https://sim1.vaak.lindenlab.com:12043/cap/76285bf1-41ed-d373-c342-e195d912dd9f', 'sim_access': 'PG', 'connect': True, 'sim_host': '8.4.131.62', 'circuit_code': 406235137, 'sim_port': 13000, 'seed_capability': 'https://sim1.vaak.lindenlab.com:12043/cap/76285bf1-41ed-d373-c342-e195d912dd9f'}
        ...
        self.host = IHost((avatar.region.details['sim_ip'],
                    int(avatar.region.details['sim_port'])))
